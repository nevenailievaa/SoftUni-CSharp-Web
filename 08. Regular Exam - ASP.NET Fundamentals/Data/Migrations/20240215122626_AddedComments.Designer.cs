...
namespace SeminarHub.Data.Migrations
{
    ...
    [Migration("20240215122626_AddedComments")]
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.Category", b =>
                {
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasComment("This is the Category's Name.");
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.Seminar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("This is the Primary Key of the Seminar.");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"), 1L, 1);

                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasComment("This is the Category's Primary Key.");

                    b.Property<DateTime>("DateAndTime")
                        .HasColumnType("datetime2")
                        .HasComment("This is the Seminar's Date and Time.");

                    b.Property<string>("Details")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("This is the Seminar's Details. It's like a description of the Seminar.");

                    b.Property<int?>("Duration")
                        .HasColumnType("int")
                        .HasComment("This is the Seminar's Duration in minutes.");

                    b.Property<string>("Lecturer")
                        .IsRequired()
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)")
                        .HasComment("This is the Seminar's Lecturer name.");

                    b.Property<string>("OrganizerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("This is the Organizer's Primary Key.");

                    b.Property<string>("Topic")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("This is the Seminar's Topic name.");
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.SeminarParticipant", b =>
                {
                    b.Property<int>("SeminarId")
                        .HasColumnType("int")
                        .HasComment("This is the Seminar's Primary Key.");

                    b.Property<string>("ParticipantId")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("This is the Participant's Primary Key.");
